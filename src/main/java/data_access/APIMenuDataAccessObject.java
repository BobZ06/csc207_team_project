...
public class APIMenuDataAccessObject implements
    ...
    private JSONObject getLocalMenuByKeyword(String name) throws Exception {
        ...
        if (lowerName.contains("burger") || lowerName.contains("mcdonald") || lowerName.contains("king") || lowerName.contains("shack")) {
        ...
        else if (lowerName.contains("pizza") || lowerName.contains("domino") || lowerName.contains("hut")) {
        ...
        else if (lowerName.contains("noodle") || lowerName.contains("ramen") || lowerName.contains("pho")) {
        ...
        else if (lowerName.contains("sushi") || lowerName.contains("japan")) {
        ...
        else if (lowerName.contains("chinese") || lowerName.contains("wok") || lowerName.contains("panda")) {
        ...
        else if (lowerName.contains("indian") || lowerName.contains("curry") || lowerName.contains("tandoori")) {
        ...
        else if (lowerName.contains("mexican") || lowerName.contains("taco") || lowerName.contains("burrito")) {
        ...
        else if (lowerName.contains("coffee") || lowerName.contains("cafe") || lowerName.contains("starbucks") || lowerName.contains("tim")) {
        ...
        else if (lowerName.contains("salad") || lowerName.contains("green") || lowerName.contains("healthy")) {
        ...
        else if (lowerName.contains("sandwich") || lowerName.contains("sub")) {
